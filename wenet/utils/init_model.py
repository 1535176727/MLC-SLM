...
from wenet.whisper.whisper_finetuning_qwen import WhisperQwen
#from wenet.SHNU_masr.SHNU_masr import SHNU_masr
from wenet.SHNU_masr.SHNU_masr19 import SHNU_masr
   ...
   #  hubert_encoder = None
    ...
    if model_type == "SHNU-mASR":
        model = WENET_MODEL_CLASSES[model_type](
            #whisper_encoder=whisper_model.base_model.model.model.encoder,
            whisper_encoder=(
